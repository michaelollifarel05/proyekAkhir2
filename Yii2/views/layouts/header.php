...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">PA2 - Electromagnetic Doorlock System</span><span class="logo-lg">' . 'PA2 - Electromagnetic Doorlock System'. '</span>', Yii::$app->homeUrl,['class' => 'logo']) ?>
